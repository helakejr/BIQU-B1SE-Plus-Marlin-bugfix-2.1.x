...
#define STRING_CONFIG_H_AUTHOR "(Ed Lake, BIQU B1 SE Plus)" // Who made the changes.
...
#define Z_DRIVER_TYPE  TMC2208		//TMC2225 drives 2 Z-Motors
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  21.10,  23.34 }
    #define DEFAULT_Ki_LIST {   1.16,   1.85 }
    #define DEFAULT_Kd_LIST {  95.56,  73.55 }
  #else
	// BIQU B1 SE Plus	M106 S255; M303 E0 S210 C10
    #define DEFAULT_Kp  21.10
    #define DEFAULT_Ki   1.16
    #define DEFAULT_Kd  95.56
  #endif
#else
...
#define PIDTEMPBED
  ...
  //BIQU B1 SE Plus	M303 E-1 S60 C10
  #define DEFAULT_bedKp 153.43
  #define DEFAULT_bedKi  29.06
  #define DEFAULT_bedKd 540.07
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79.13, 79.56, 399.41, 92 }
